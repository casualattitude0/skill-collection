---
name: whereto
description: Work out what phase a project is in and what to build next. Point it at any Game, APP, or WEB folder — reads source, docs, assets, tests, and git history, scores the phase against evidence, then writes PROJECT_PHASE.md (roadmap + scored next slice) and IMPLEMENTATION_HANDOFF.md (a build package a coding agent can execute). Use for "what phase is this in", "where should this go next", "I inherited this project". NOT when only one narrow bundled tool is needed.
license: MIT
